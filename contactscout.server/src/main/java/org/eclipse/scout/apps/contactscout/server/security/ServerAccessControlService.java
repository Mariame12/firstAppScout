package org.eclipse.scout.apps.contactscout.server.security;

import org.eclipse.scout.apps.contactscout.shared.security.AccessControlService;
...
public class ServerAccessControlService extends AccessControlService {
  ...
  protected IPermissionCollection execLoadPermissions(String userId) {
    ...
    //TODO [mariamesasconte]: Fill access control service - or replace this default implementation by simply return BEANS.get(AllPermissionCollection.class)
