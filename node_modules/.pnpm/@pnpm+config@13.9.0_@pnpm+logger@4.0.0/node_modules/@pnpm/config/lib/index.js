...
const npm_conf_1 = __importDefault(require("@zkochan/npm-conf"));
const types_1 = __importDefault(require("@zkochan/npm-conf/lib/types"));
...
const getScopeRegistries_1 = __importDefault(require("./getScopeRegistries"));
...
async function which(cmd) {
    return new Promise((resolve, reject) => {
        (0, which_1.default)(cmd, (err, resolvedPath) => (err != null) ? reject(err) : resolve(resolvedPath));
    });
}
...
exports.default = async (opts) => {
    ...
    const pnpmConfig = (0, fromPairs_1.default)([
    ...
    const cwd = (_c = (cliOptions.dir && path_1.default.resolve(cliOptions.dir))) !== null && _c !== void 0 ? _c : npmConfig.localPrefix;
    ...
    if (cliOptions['global']) {
        ...
        if (pnpmConfig['globalDir']) {
            ...
            globalDirRoot = path_1.default.join(pnpmConfig.pnpmHomeDir, 'global-packages');
        }
        else {
            let npmGlobalPrefix = (0, findBestGlobalPrefix_1.default)(npmConfig.globalPrefix, process.env);
            ...
            globalDirRoot = path_1.default.join(firstWithWriteAccess([npmGlobalPrefix, os_1.default.homedir()]), PNPM_GLOBAL);
        }
        ...
        if (typeof npmConfigGlobalBinDir === 'string') {
            fs_1.default.mkdirSync(npmConfigGlobalBinDir, { recursive: true });
            ...
            pnpmConfig.bin = cliOptions.dir
                ...
                : (0, global_bin_dir_1.default)(knownGlobalBinDirCandidates, { shouldAllowWrite: opts.globalDirShouldAllowWrite === true });
        }
    ...
    if (!pnpmConfig.configDir) {
        pnpmConfig.configDir = (0, dirs_1.getConfigDir)(process);
    }
    ...
    if (!pnpmConfig.httpsProxy) {
        pnpmConfig.httpsProxy = (_f = pnpmConfig.proxy) !== null && _f !== void 0 ? _f : getProcessEnv('https_proxy');
    }
    if (!pnpmConfig.httpProxy) {
        pnpmConfig.httpProxy = (_h = (_g = pnpmConfig.httpsProxy) !== null && _g !== void 0 ? _g : getProcessEnv('http_proxy')) !== null && _h !== void 0 ? _h : getProcessEnv('proxy');
    }
    if (!pnpmConfig.noProxy) {
        pnpmConfig.noProxy = (_j = pnpmConfig['noproxy']) !== null && _j !== void 0 ? _j : getProcessEnv('no_proxy');
    }
    pnpmConfig.enablePnp = pnpmConfig.nodeLinker === 'pnp';
    if (!pnpmConfig.userConfig) {
        pnpmConfig.userConfig = (_k = npmConfig.sources.user) === null || _k === void 0 ? void 0 : _k.data;
    }
    if (opts.checkUnknownSetting) {
        const settingKeys = Object.keys({
            ...(_m = (_l = npmConfig === null || npmConfig === void 0 ? void 0 : npmConfig.sources) === null || _l === void 0 ? void 0 : _l.workspace) === null || _m === void 0 ? void 0 : _m.data,
            ...(_p = (_o = npmConfig === null || npmConfig === void 0 ? void 0 : npmConfig.sources) === null || _o === void 0 ? void 0 : _o.project) === null || _p === void 0 ? void 0 : _p.data,
        }).filter(key => key.trim() !== '');
        const unknownKeys = [];
    ...
    if (!pnpmConfig.ignorePnpmfile) {
        pnpmConfig.hooks = (0, pnpmfile_1.requireHooks)((_q = pnpmConfig.lockfileDir) !== null && _q !== void 0 ? _q : pnpmConfig.dir, pnpmConfig);
    }
    pnpmConfig.rootProjectManifest = (_s = await (0, read_project_manifest_1.safeReadProjectManifestOnly)((_r = pnpmConfig.lockfileDir) !== null && _r !== void 0 ? _r : pnpmConfig.dir)) !== null && _s !== void 0 ? _s : undefined;
...
function firstWithWriteAccess(dirs) {
    ...
    if (first == null) {
        throw new error_1.default('NO_SUITABLE_GLOBAL_DIR', `pnpm has no write access to global direcotry. Tried locations: ${dirs.join(', ')}`);
    }
    return first;
}
