...
const render_peer_issues_1 = __importDefault(require("@pnpm/render-peer-issues"));
    ...
    if (logObj['err']) {
        ...
        switch (err.code) {
            ...
            default: {
                ...
                if (logObj['hint']) {
                    errorOutput.push(logObj['hint']);
                }
                return {
                    title: (_e = err.message) !== null && _e !== void 0 ? _e : '',
                    body: errorOutput.join(constants_1.EOL),
                };
            }
        }
    }
...
function formatErrorSummary(message, code) {
    return `${chalk_1.default.bgRed.black(`\u2009${code !== null && code !== void 0 ? code : 'ERROR'}\u2009`)} ${chalk_1.default.red(message)}`;
}
