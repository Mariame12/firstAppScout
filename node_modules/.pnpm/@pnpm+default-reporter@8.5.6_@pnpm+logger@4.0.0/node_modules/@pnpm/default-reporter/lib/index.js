...
function toOutput$(opts) {
    ...
    if (((_b = (_a = opts.context.config) === null || _a === void 0 ? void 0 : _a.hooks) === null || _b === void 0 ? void 0 : _b.filterLog) != null) {
    ...
    const outputs = (0, reporterForClient_1.default)(log$, {
        appendOnly: (_c = opts.reportingOptions) === null || _c === void 0 ? void 0 : _c.appendOnly,
        cmd: opts.context.argv[0],
        config: opts.context.config,
        isRecursive: ((_d = opts.context.config) === null || _d === void 0 ? void 0 : _d['recursive']) === true,
